    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{ route('store.subdistrict') }}">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">SubDistrict Japanese</label>
            <input type="text" class="form-control" name="subdistrict_jp"  placeholder="SubDistrict Japanese">
            @error('subdistrict_jp')
            <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
          <div class="form-group">
