...
<div class="content-wrapper">
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">News Post Updete</h4>
            ...
            <form class="forms-sample" action="{{ route('update.post',$post->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="title_jp" class="form-control" id="exampleInputName1" value="{{ $post->title_jp }}">
                    </div>
                </div> <!-- End Row -->
               ...
               <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="examleFormControlFile1">Ole Image</label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                       ...
                       <input type="text" name="tags_jp" class="form-control" id="exampleInputName1" value="{{ $post->tags_jp }}">
                    </div>
                </div> <!-- End Row -->
                ...
                <div class="row">
                    ...
                    <label class="form-check-label col-md-3">
                        ...
                        First Section Big Thumbnail <i class="input-helper"></i>
                    </label>
                </div> <!-- End Row -->
