    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{ route('update.subcategory',$subcategory->id) }}">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">SubCategory Japanese</label>
            <input type="text" class="form-control" name="subcategory_jp"  value="{{ $subcategory->subcategory_jp }}">
            ...
            <select class="form-control" name="category_id">
                <option disabled="" selected="">--Select Category</option>
                    ...
                    <option value="{{ $row->id }}"
                        ...
                        >{{ $row->category_en }} | {{ $row->category_jp }}
                </option>
                    @endforeach
            </select>
          </div>
