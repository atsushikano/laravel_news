...
<div class="content-wrapper">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">
            <h4 class="card-title">Photo Gallery Page</h4>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $row->title }} </td>
                        <td> <img src="{{ asset($row->photo) }}" style="width: 50px; heght: 50px"; alt=""> </td>
                        <td>
                            @if ($row->type == 1)
                        ...
                        <td>
                            ...
                            <a href="{{ route('delete.photo',$row->id) }}" onclick="return confirm('Are You Sure ?')" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
